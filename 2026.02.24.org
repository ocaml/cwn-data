...
[[https://alan.petitepomme.net/cwn/2026.02.17.html][Previous Week]] [[https://alan.petitepomme.net/cwn/index.html][Up]] [[https://alan.petitepomme.net/cwn/2026.03.03.html][Next Week]]
...
:CUSTOM_ID: 1
:END:
Archive: https://inbox.ci.dev/caml-list/c3298309-a06d-4ac8-874c-fe2104078e61@mehnert.org/T/
...
:CUSTOM_ID: 2
:END:
Archive: https://discuss.ocaml.org/t/ocaml-5-4-1-and-4-14-3-released/17822/1
...
More importantly, those new versions harden the Marshal module against malicious inputs as described in the security announcement [[https://osv.dev/vulnerability/OSEC-2026-01][OSEC-2026-01]].

We are encouraging you to switch to those new releases whenever possible.

Don't hesitate to report any bugs on the [[https://github.com/ocaml/ocaml/issues][OCaml issue tracker]].
...
- [[https://github.com/ocaml/ocaml/issues/12070][#12070]], [[https://github.com/ocaml/ocaml/issues/12075][#12075]], [[https://github.com/ocaml/ocaml/issues/13209][#13209]]: auto-detect whether ~ar~ support @FILE arguments at
...
- [[https://github.com/ocaml/ocaml/issues/13430][#13430]], [[https://github.com/ocaml/ocaml/issues/13434][#13434]]: protect memory-safety on Lazy.force races
  (Gabriel Scherer and Vincent Laviron, report by Edwin Török,
   review by Vincent Laviron)

- [[https://github.com/ocaml/ocaml/issues/13448][#13448]], [[https://github.com/ocaml/ocaml/issues/13449][#13449]]: fix a code-generation bug on unsafe array accesses
...
- [[https://github.com/ocaml/ocaml/issues/13516][#13516]]: Fix regression where error conditions during bytecode initialisation
  caused a segmentation fault rather than being properly reported (regression of
  [[https://github.com/ocaml/ocaml/issues/5115][#5115]] in [[https://github.com/ocaml/ocaml/issues/11788][#11788]])
  (David Allsopp, review by Nicolás Ojeda Bär)

- [[https://github.com/ocaml/ocaml/issues/13847][#13847]]: On Windows, maintain a number of threads waiting on the master lock to
  avoid unnecessary context switches
  (Dmitry Bely, review by Antonin Décimo)

- [[https://github.com/ocaml/ocaml/issues/14007][#14007]], [[https://github.com/ocaml/ocaml/issues/14015][#14015]]: Fix memory corruption when an exception is raised during
  demarshaling.
  (Benoît Vaugon, review by David Allsopp and Gabriel Scherer)

- [[https://osv.dev/vulnerability/OSEC-2026-01][OSEC-2026-01]]: robustify intern.c
...
- [[https://github.com/ocaml/ocaml/issues/14010][#14010]]: Fix miscompilation / liveness errors for string operations
  (Mark Shinwell, Xavier Clerc, review by Xavier Leroy and Gabriel Scherer)

- [[https://github.com/ocaml/ocaml/issues/14065][#14065]]: Fix function signature mismatch of ~__tsan_func_exit~ with GCC 15.
...
- [[https://github.com/ocaml/ocaml/issues/14417][#14417]]: Fix issue with nested packs on macOS.
  (Vincent Laviron, report by Kate Deplaix, review by Gabriel Scherer)

- [[https://github.com/ocaml/ocaml/issues/14213][#14213]]: Fix shadow-stack-related crashes with TSan
  (Olivier Nicole, report by Nathan Taylor, review by Gabriel Scherer and
   Stefan Muenzel)

- [[https://github.com/ocaml/ocaml/issues/14255][#14255]]: Fix TSan bug with C calls that take many arguments
...
:CUSTOM_ID: 3
:END:
Archive: https://discuss.ocaml.org/t/ann-ochat-try-ochat-for-terminal-based-llm-workflows/17829/1
...
:CUSTOM_ID: 4
:END:
Archive: https://discuss.ocaml.org/t/ann-serialport-new-serial-communication-library/17594/3

** Continuing this thread, Mikhail announced


[[https://github.com/dx3mod/serialport/commit/d057a004c050234b64e4edbee2c13a04bf4c2734][Added]] (aka implemented) Win32 support, which has not been thoroughly tested, but may be useful for certain target use cases.
...
The featured new feature of this release is the ability to easily integrate [[https://www.manim.community/][Manim]] videos in your presentation.
...
- Support for Mermaid JS ([[https://github.com/panglesd/slipshow/pull/205][#205]])
- Support for syntax highlighting of all highlightjs-supported languages and themes ([[https://github.com/panglesd/slipshow/pull/200][#200]], [[https://github.com/panglesd/slipshow/pull/208][#208]])
- Support for MathJax extensions, especially the html extension to allow actions to target math elements ([[https://github.com/panglesd/slipshow/pull/202][#202]])
- Add KaTeX as a possible alternate renderer ([[https://github.com/panglesd/slipshow/pull/202][#202]])
- Added ~carousel-fixed-size~ to have carousel not change size ([[https://github.com/panglesd/slipshow/pull/207][#207]])

*** Fix

- Fix impossibility to reopen speaker view after closing it on Firefox ([[https://github.com/panglesd/slipshow/pull/198][#198]], issue [[https://github.com/panglesd/slipshow/issues/194][#194]])
- Fix impossibility to open speaker view in serve mode ([[https://github.com/panglesd/slipshow/pull/198][#198]], issue [[https://github.com/panglesd/slipshow/issues/197][#197]])
- Fix links opening inside iframe ([[https://github.com/panglesd/slipshow/pull/198][#198]])
- Fix ending excursions with ~ijkl~ only when needed ([[https://github.com/panglesd/slipshow/pull/207][#207]])
- Fixed video long-step handling ([[https://github.com/panglesd/slipshow/pull/207][#207]])
- Removed confusing auto-generated IDs ([[https://github.com/panglesd/slipshow/pull/209][#209]])
- Fix ~play-media~ behavior when facing errors ([[https://github.com/panglesd/slipshow/pull/210][#210]])

*** Docs

- Add how to include TikZ figures in your Slipshow presentation ([[https://github.com/panglesd/slipshow/pull/206][#206]])
- Add how to include Manim videos in your Slipshow presentation ([[https://github.com/panglesd/slipshow/pull/207][#207]])
...
:CUSTOM_ID: 6
:END:
Archive: https://discuss.ocaml.org/t/remote-ocaml-distributed-systems-engineer-linux-storage-networking-whitesky-cloud-emea-asia/17832/1
...
I’m excited to announce the release of [[https://github.com/johnyob/grace/releases/tag/0.3.0][grace 0.3.0]], an OCaml library for building, reporting and rendering beautiful compiler diagnostics :camel: :paintbrush:. Now available on [[https://github.com/ocaml/opam-repository/pull/29379][opam-repository]].
...
- feat(renderer): add breaks in large diagnostics ([[https://github.com/johnyob/grace/pull/63][#63]])
- feat(renderer): check for tty when rendering ([[https://github.com/johnyob/grace/pull/60][#60]])
- fix(renderer): off-by-one in ~lines_of_labels~ ([[https://github.com/johnyob/grace/pull/65][#65]])
- fix(renderer): create 0-sized segment on empty label range ([[https://github.com/johnyob/grace/pull/64][#64]])
- fix(renderer): renderer multi-line labels when message is empty ([[https://github.com/johnyob/grace/pull/53][#53]])
- fix(renderer): fix errors that occur with special zero-width segments ([[https://github.com/johnyob/grace/pull/41][#41]])
- fix(renderer): use ~Format.pp_infinity~ in ~Message.to_string~ for OCaml >5.2 ([[https://github.com/johnyob/grace/pull/40][#40]])
- refactor!: removes base/core dependency ([[https://github.com/johnyob/grace/pull/58][#58]])
...
:CUSTOM_ID: 8
:END:
Archive: https://discuss.ocaml.org/t/ann-js-of-ocaml-wasm-of-ocaml-6-3/17834/1
...
See the [[https://github.com/ocsigen/js_of_ocaml/blob/master/CHANGES.md][Changelog]] for the full list of changes.
...
I'd like to announce a new release for [[https://opam.ocaml.org/packages/kqueue/kqueue.0.5.0/][kqueue-ml version 0.5.0]]

*Kqueue-ml:* Thin bindings to kqueue event notification system. 

Changes since the last release:

- Moved development to [[https://codeberg.org/anuragsoni/kqueue-ml/][codeberg]]
...
The Dune team announces [[https://github.com/ocaml/dune/releases/tag/3.21.1][the release of dune 3.21.1]].

This is a small patch release consisting of a few bug fixes. See [[https://github.com/ocaml/dune/releases/tag/3.21.1][the full changelog]] for all the changes.
...
- [[https://anil.recoil.org/notes/india-ai-summit][At the AI Impact Summit in Delhi: people, planet, progress]]
- [[https://www.tunbury.org/2026/02/19/obuilder-hcs/][OBuilder on Windows: Bringing Native Container Builds with the HCS Backend]]
- [[https://anil.recoil.org/notes/first-tessera-hackathon][1st TESSERA/CoRE hackathon at the Indian AI Summit]]
