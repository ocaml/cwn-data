...
[[https://alan.petitepomme.net/cwn/2026.04.21.html][Previous Week]] [[https://alan.petitepomme.net/cwn/index.html][Up]] [[https://alan.petitepomme.net/cwn/2026.05.05.html][Next Week]]
...
:CUSTOM_ID: 1
:END:
Archive: https://discuss.ocaml.org/t/closing-old-bugs-with-tests-a-dune-contribution-story/18008/1
...
- [[https://github.com/ocaml/dune/issues/1974][#1974]] --- ~@all~ target doesn't interact well with ~(include_subdirs ...)~ (filed 2019)
- [[https://github.com/ocaml/dune/issues/3173][#3173]] --- Can't promote into a directory starting with underscore (filed 2020)
- [[https://github.com/ocaml/dune/issues/3805][#3805]] --- No such file or directory when ~DUNE_BUILD_DIR~ is set during test (filed 2020)
- [[https://github.com/ocaml/dune/issues/8242][#8242]] --- Very slow emacs compilation buffer updates (filed 2023)
- [[https://github.com/ocaml/dune/issues/10360][#10360]] --- ~executables_implicit_empty_intf~ expects dune >= 2.9 but was only added in 3.0 (filed 2024)
...
- [[https://github.com/ocaml/dune/issues/2370][#2370]] --- ~.h~ files copied to ~_build~ without foreign stubs (filed 2019, test: [[https://github.com/ocaml/dune/pull/14172][#14172]])
- [[https://github.com/ocaml/dune/issues/3362][#3362]] --- Cannot use ~%{lib:...}~ in the ~flags~ stanza (filed 2020, test: [[https://github.com/ocaml/dune/pull/14146][#14146]])
- [[https://github.com/ocaml/dune/issues/3484][#3484]] --- Promoting over a running binary (filed 2020, test: [[https://github.com/ocaml/dune/pull/14173][#14173]])
- [[https://github.com/ocaml/dune/issues/11110][#11110]] --- Libexec site install doesn't set executable bit (filed 2024, test: [[https://github.com/ocaml/dune/pull/14171][#14171]])

**** Closed with a test and a code fix

These required both a test and a code change to resolve:

- [[https://github.com/ocaml/dune/issues/878][#878]] --- ~dune subst~ adds duplicate version field in opam (filed 2018, fix: [[https://github.com/ocaml/dune/pull/14136][#14136]])
- [[https://github.com/ocaml/dune/issues/2445][#2445]] --- dune sends SIGKILL without prior SIGTERM (filed 2019, fixes: [[https://github.com/ocaml/dune/pull/14170][#14170]], [[https://github.com/ocaml/dune/pull/14224][#14224]])
- [[https://github.com/ocaml/dune/issues/3916][#3916]] --- Duplicate bounds in autogenerated opam files (filed 2020, fix: [[https://github.com/ocaml/dune/pull/14175][#14175]])
- [[https://github.com/ocaml/dune/issues/6148][#6148]] --- ~root_module~ generates duplicate module definition (filed 2022, fix: [[https://github.com/ocaml/dune/pull/14135][#14135]])
- [[https://github.com/ocaml/dune/issues/9757][#9757]] --- ~dune runtest~ doesn't execute byte-only inline tests (filed 2024, fix: [[https://github.com/ocaml/dune/pull/14174][#14174]])
- [[https://github.com/ocaml/dune/issues/10707][#10707]] --- Missing menhir lower bound in generated opam files (filed 2024, fix: [[https://github.com/ocaml/dune/pull/14168][#14168]])
- [[https://github.com/ocaml/dune/issues/11002][#11002]] --- opam file generation error-prone (filed 2024, fix: [[https://github.com/ocaml/dune/pull/14136][#14136]])
- [[https://github.com/ocaml/dune/issues/11106][#11106]] --- Redundant dune version constraint in opam files (filed 2024, fix: [[https://github.com/ocaml/dune/pull/14175][#14175]])
- [[https://github.com/ocaml/dune/issues/12007][#12007]] --- ~dune build @ocaml-index~ builds too many files (filed 2025, partially fixed with [[https://github.com/ocaml/dune/pull/14137][#14137]])
- [[https://github.com/ocaml/dune/issues/14089][#14089]] --- Incremental builds with ~(wrapped (transition ...))~ broken (filed 2026, test: [[https://github.com/ocaml/dune/pull/14088][#14088]], fix: [[https://github.com/ocaml/dune/pull/14090][#14090]])
...
- The central data structure is EverParse's [[https://project-everest.github.io/everparse/3d.html#language-reference][3D grammar]]. The OCaml combinators describe a 3D structure. Following [[https://github.com/dbuenzli/jsont/blob/main/paper/soup.pdf][Daniel's tagged final encoding approach]], you build a codec that describes a struct and how to serialise/deserialise it from an OCaml value.
...
Feedback very welcome [[https://github.com/parsimoni-labs/ocaml-wire][on the issue tracker]] (or bellow)!
...
:CUSTOM_ID: 4
:END:
Archive: https://discuss.ocaml.org/t/ann-unifiedscript-std-top-literate-testing/18013/1

** jbeckford announced


I am pleased to introduce the ~UnifiedScript_Std~ and ~UnifiedScript_Top~ packages. Unified scripts are a way to write tests and documentation simultaneously. Cram tests and [[https://github.com/realworldocaml/mdx][MDX scripts]] are both similar to unified scripts, but unified scripts aren't tied to Markdown (MDX) or tied to POSIX shell commands (cram tests).
 
Examples:

- /Markdown example/: Here are the zillions of tests from ~ocaml-re~ converted into Markdown: [[https://github.com/jonahbeckford/ocaml-re/blob/7dbfc446bd594303add00f443bdea206b08511c2/EXAMPLES.md][ocaml-re/EXAMPLES.md]]. Custom OCaml REPL printers are used so that many of the tests are printed as Markdown tables. /aside: Wouldn't it be nice if tests you are already writing became documentation? That was a 4 year follow-up to https://discuss.ocaml.org/t/what-are-the-biggest-reasons-newcomers-give-up-on-ocaml/10958/13?u=jbeckford/
- /~.ml~ example/: The following is a snippet from [[https://gitlab.com/dkml/build-tools/MlFront/-/blob/374bbac77003cd8cee56f0664cec974aa314c648/src/UnifiedScript_Top/plainmodule.ml][a regular OCaml ~.ml~ module]] where the ~(* ... *)~ comments are OCaml REPL toplevel responses maintained by the unified tools.
  #+begin_src ocaml
  let lyrics =
...
Docs are at [[https://github.com/diskuv/dk/blob/ffa130a1dbefcd134b0d15f112fd6d6c99dc0fc8/docs/UNIFIED_SCRIPTS.md][dk/docs/UNIFIED_SCRIPTS.md]] (of course generated by the unified tools).
...
After feedback I'll release them officially to opam. I would like feedback overall and also specifically on the [[https://github.com/jonahbeckford/ocaml-re/blob/make-literate-tests/.claude/skills/make-literate-tests/SKILL.md][agent skill that converts expect tests to unified tests]].
...
:CUSTOM_ID: 5
:END:
Archive: https://discuss.ocaml.org/t/ann-openrouter-api-an-openrouter-client-library/18016/1
...
- GitHub: [[https://github.com/mt-caret/openrouter-ocaml][https://github.com/mt-caret/openrouter-ocaml]]
...
:CUSTOM_ID: 6
:END:
Archive: https://discuss.ocaml.org/t/call-for-presentations-caml-in-the-capital-ii/17959/2

** Continuing this thread, Sacha Ayoun announced


Date and location have been confirmed! June 3rd at the Jane Street office!!
